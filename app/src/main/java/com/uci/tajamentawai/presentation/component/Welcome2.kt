...
@Composable
fun Welcome2Screen(navController: NavController){
    Column(
        ...
        Column(
            ...
            Image(
                painter = painterResource(id = R.drawable.wel2),
                contentDescription = " ",
                modifier = Modifier
                    .fillMaxWidth()
                    .height(400.dp)
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = "Access a selection of hidden\ngem holiday destinations to\nMentawai Island",
                ...
                Column(
                    ...
                    Text(
                        ...
                        color = Color.DarkGray,
                        textAlign = TextAlign.Center,
                        modifier = Modifier.clickable { navController.navigate(Screen.Welcome3.route) }
                    )
                }
            }
        }
