...
@Composable
fun Welcome1Screen(navController: NavController){
    ...
    Column(
        ...
        Column(
            ...
            Image(
                painter = painterResource(id = R.drawable.welc1),
                contentDescription = " ",
                modifier = Modifier
                    .fillMaxWidth()
                    .height(400.dp)
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = "Plan Your Trip, choose your\ndestination. Pick the best\nlocalguide for your holiday",
                ...
                Column(
                    ...
                    Text(
                        ...
                        color = Color.DarkGray,
                        textAlign = TextAlign.Center,
                        modifier = Modifier.clickable { navController.navigate(Screen.Welcome2.route) }
                    )
                }
            }
        }
